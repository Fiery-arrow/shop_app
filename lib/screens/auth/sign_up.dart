...
class _SignUpScreenState extends State<SignUpScreen> {
    ...
    if (isValid) {
      ...
      try {
        if (_pickedImage == null) {
          _globalMethods.authErrorHandle(context, "Please pick an image");
        } else {
          setState(() {
            _isLoading = true;
          });
          ...
          Container(
            ...
            child: RotatedBox(
              ...
              child: WaveWidget(
                config: CustomConfig(
                  gradients: [
                    [ColorsConst.gradiendFStart, ColorsConst.gradiendLStart],
                                ...
                                return AlertDialog(
                                  title: Text(
                                    ...
                                    style: TextStyle(
                                        ...
                                        color: ColorsConst.gradiendLStart),
                                  ),
                                  content: SingleChildScrollView(
                                    child: ListBody(
                                      children: [
                                        buildInkWellForDialog(
                                            Icons.camera,
                                            "Camera",
                                            Colors.purpleAccent,
                                            ColorsConst.title,
  ...
  InkWell buildInkWellForDialog(
      IconData icon, String title, iconColor, txtColor, Function fun) {
    return InkWell(
      onTap: fun,
